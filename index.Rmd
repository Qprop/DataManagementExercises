...
You can find the dataset in the data folder then folder named **English Premier League_09_19** [source of data](https://datahub.io/sports-data/english-premier-league#resource-english-premier-league_zip). 
...
This can be found under the **Data>College Majors** folders.
...
This can be found under the **Data>Video Games** folders.
...
Link to quiz [here](https://qprop.shinyapps.io/instructor_exam/)
